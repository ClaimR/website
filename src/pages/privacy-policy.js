...
const PolicyBody = () => (
  <>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          the Company downloaded by You on any electronic device, named ClaimR
          Auth
        </p>
      </li>
      <li>
        <p>
          ...
          this Agreement) refers to ClaimR BV, Guardianenhof 18, 5211 WR.
        </p>
    ...
    <ul>
      <li>By email: info@claimr.tools</li>
    </ul>
  </>
)
