        ...
        <div className="grid-wrapper">
          <div className="col-6">
            ...
            <p>
              ...
              simple, hence you do not need to know anything about the
              intricacies of GNSS in order to reap its benifits when using
              ClaimR.
            </p>
          </div>
          <div className="col-6">
      ...
      <section id="two" className="main style2">
        <div className="grid-wrapper">
          ...
          <div className="col-6">
            ...
            <p>
              Proving one’s location for additional security can be a challenge
              at best. Not only is it hard to prove, there are also further
              privacy concerns associated with it, thus requires an
              implementation that all parties can trust. To aid in this security
              obstacle we created ClaimR, a third party service verifying ones
              location with a signed certificate.
            </p>
            <p>
              Using raw GNSS data from your mobile we are able to determine your
              location and create a signed certificate verifying your location
              to any service requiring the information. Depending on the
              request, we can provide an exact pin pointed location or a more
              generic and broad placement, such as the city of London. ClaimR
              also makes location faking using software much harder due to the
              use of raw GNSS data, massively reducing the ease of attack.
            </p>
            <p>
        ...
        <div className="grid-wrapper">
          ...
          <div className="col-4">
            ...
            <p>
              ...
              mobile devices to get in-game advantages. ClaimR acts as a second
              opinion such that{' '}
              <b>
          ...
          <div className="col-4">
            ...
            <p>
              ...
              be a user and get access to data on where all vehicles are. Limit
              the data a user can access to merely what's in their direct
              surroundings eliminates this threat. With verified location you
              can{' '}
              <b>
          ...
          <div className="col-4">
            ...
            <p>
              ...
              the user is within a certain area. You can decide what this area
              is based on your use-case, it can be anything between a couple of
